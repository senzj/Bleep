...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderUploadedList(sounds) {
        ...
        sounds.forEach(s => {
            ...
            row.innerHTML = `
                <i data-lucide="file-audio" class="w-4 h-4 text-primary shrink-0"></i>
...
<x-settings.layout>
    ...
    <div class="space-y-6">
        ...
        {{-- Preferences Section --}}
        <div class="border-b border-gray-500/50 p-4 gap-3 flex flex-col">
            ...
            {{-- Theme Selection --}}
            <div class="border border-base-200 shadow-lg p-3 rounded-lg gap-2 flex flex-col">
                ...
                <div class="bg-base-200 rounded-lg p-4 space-y-4">
                    ...
                    <div class="form-control flex flex-col border border-base-200 p-3 rounded-lg bg-base-100">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <div class="flex items-center gap-2">
                                <button type="button"
                                        class="btn btn-ghost btn-xs sound-preview-btn"
                    ...
                    <div class="form-control flex flex-col border border-base-200 p-3 rounded-lg bg-base-100">
                        ...
                        <div class="flex items-center justify-between mb-3">
                            <span class="label-text font-medium">Upload Custom Sound</span>
                            <span class="text-xs text-base-content/40">MP3, WAV, OGG, M4A · max 5 MB</span>
                        </div>

                        {{-- Drop zone --}}
                        <div id="sound-drop-zone"
                            class="relative flex flex-col items-center justify-center gap-2 border-2 border-dashed border-base-300 rounded-lg p-6 cursor-pointer hover:border-primary hover:bg-primary/5 transition-colors">
                            <i data-lucide="music" class="w-8 h-8 text-base-content/30 pointer-events-none"></i>
                        ...
                        <div id="sound-upload-preview" class="hidden mt-3 flex items-center gap-3 p-3 bg-base-200 rounded-lg">
                            <i data-lucide="file-audio" class="w-5 h-5 text-primary shrink-0"></i>
