<nav class="relative" aria-label="Settings navigation">
    ...
    <nav class="flex gap-2 w-full" aria-label="Settings navigation">
        {{-- Profile  --}}
        <a href="{{ route('settings.profile') }}"
           aria-current="{{ request()->routeIs('settings.profile') ? 'page' : 'false' }}"
           class="flex flex-1 items-center justify-center gap-2 px-3 py-2 md:px-4 rounded-lg text-sm font-medium transition-colors
