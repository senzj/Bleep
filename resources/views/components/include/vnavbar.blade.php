...
<button id="hor-mobile-menu-btn" class="fixed bottom-5 left-5 z-10 lg:hidden bg-base-100 border rounded-lg p-3 shadow hover:bg-base-200 transition-colors" aria-label="Open menu">
