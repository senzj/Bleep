...
>
    ...
    {{-- Wrapper --}}
    <div class="bg-base-100 rounded-lg p-2 shadow-lg border border-gray-500/20 hover:shadow-xl transition-shadow duration-200" data-bleep-card="{{ $bleep->id }}">
                    ...
                    <div class="bleep-nsfw-wrapper" data-bleep-id="{{ $bleep->id }}" data-is-nsfw="{{ $isNsfw ? '1' : '0' }}" data-is-anonymous="{{ $bleep->is_anonymous ? '1' : '0' }}">
                        ...
                        <div class="normal-bleep-content {{ $isNsfw ? 'hidden' : '' }}">
                            @if(!empty($bleep->message))
                                ...
                                @if($cleanMessage)
                                    <div class="text-base leading-relaxed text-base-content/90 ml-1">
